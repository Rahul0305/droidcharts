 ...
 *
 * $Id: Align.java,v 1.8 2004/04/26 19:15:43 taqua Exp $
 *
...
public final class Align {
	...
	/**
	 * Aligns one rectangle (<code>rect</code>) relative to another rectangle (
	 * <code>frame</code>).
	 * 
	 * @param rect
	 *            the rectangle to be aligned.
	 * @param frame
	 *            the reference frame.
	 * @param align
	 *            the alignment type.
	 */
	public static void align(final Rectangle rect, final Rectangle frame,
			final int align) {
