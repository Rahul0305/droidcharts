...
import net.droidsolutions.droidcharts.core.data.RangeType;
...
public class NumberAxis extends ValueAxis implements Cloneable, Serializable {
	 ...
	 */
	protected double estimateMaximumTickLabelHeight(Canvas g2) {
		...
		Paint p = new Paint();
		p.setTextSize(tickLabelFont.getSize());
		Rectangle2D rec = TextUtilities.getTextBounds("123", p);
	 ...
	 */
	protected double estimateMaximumTickLabelWidth(Canvas g2, TickUnit unit) {
		...
		if (isVerticalTickLabels()) {
			...
			Paint p = new Paint();
			p.setTextSize(getTickLabelFont().getSize());
			Rectangle2D rec = TextUtilities.getTextBounds("0", p);
			result += rec.getHeight();
		} else {
	 ...
	 *            the axis location.
	 */
	protected void selectAutoTickUnit(Canvas g2, Rectangle2D dataArea,
			RectangleEdge edge) {
	 ...
	 *            the axis location.
	 */
	protected void selectHorizontalAutoTickUnit(Canvas g2,
			Rectangle2D dataArea, RectangleEdge edge) {
	 ...
	 *            the axis location.
	 */
	protected void selectVerticalAutoTickUnit(Canvas g2, Rectangle2D dataArea,
			RectangleEdge edge) {
	 ...
	 * @return A list of ticks.
	 */
	protected List refreshTicksHorizontal(Canvas g2, Rectangle2D dataArea,
			RectangleEdge edge) {
	 ...
	 * @return A list of ticks.
	 */
	protected List refreshTicksVertical(Canvas g2, Rectangle2D dataArea,
			RectangleEdge edge) {
