...
import net.droidsolutions.droidcharts.core.entity.XYItemEntity;
import net.droidsolutions.droidcharts.core.label.ItemLabelPosition;
import net.droidsolutions.droidcharts.core.label.StandardXYSeriesLabelGenerator;
...
public abstract class AbstractXYItemRenderer extends AbstractRenderer
     ...
     */
    public XYItemRendererState initialise(Canvas g2,
        ...
        if (xyplot != null) {
            ...
            if (dataset != null) {
                ...
                result = new LegendItem(label, description, "",
                        "", shape, paint.getColor(), outlineStroke, outlinePaint.getColor());
     ...
     */
    public void fillDomainGridBand(Canvas g2, XYPlot plot, ValueAxis axis,
     ...
     * @param end  the end value.
     */
    public void fillRangeGridBand(Canvas g2, XYPlot plot, ValueAxis axis,
            Rectangle2D dataArea, double start, double end) {
     ...
     */
    public void drawDomainGridLine(Canvas g2,
                                   XYPlot plot,
                                   ValueAxis axis,
                                   Rectangle2D dataArea,
                                   double value) {
     ...
     * @since 1.0.5
     */
    public void drawDomainLine(Canvas g2, XYPlot plot, ValueAxis axis,
     ...
     */
    public void drawRangeLine(Canvas g2,
                              XYPlot plot,
                              ValueAxis axis,
                              Rectangle2D dataArea,
                              double value,
     ...
     */
    public void drawDomainMarker(Canvas g2,
                                 XYPlot plot,
        ...
        p.setAlpha(marker.getAlpha());
            ...
            g2.drawRect((float)rect.getMinX(), (float)rect.getMinY(),(float) rect.getMaxX(),(float) rect.getMaxY(), p);
p.setAlpha(oldAlpha);
                ...
                if (orientation == PlotOrientation.VERTICAL) {
                   ...
                   oPiant.setStrokeWidth(im.getOutlineStroke());
                    ...
                    if (range.contains(start)) {
                        ...
                        g2.drawLine((float)line.getX1(), (float)line.getY1(), (float)line.getX2(), (float)line.getY2(), oPiant);
                    }
     ...
     * @param dataArea  the axis data area.
     */
    public void drawRangeMarker(Canvas g2,
                                XYPlot plot,
                                ValueAxis rangeAxis,
                                Marker marker,
                                Rectangle2D dataArea) {
     ...
     * @return The coordinates for drawing the marker label.
     */
    private Point2D calculateRangeMarkerTextAnchorPoint(Canvas g2,
                                      PlotOrientation orientation,
                                      Rectangle2D dataArea,
                                      Rectangle2D markerArea,
                                      RectangleInsets markerOffset,
     ...
     */
    public void drawAnnotations(Canvas g2,
                                Rectangle2D dataArea,
                                ValueAxis domainAxis,
                                ValueAxis rangeAxis,
                                Layer layer,
