...
//    public void setBaseCreateEntities(boolean create, boolean notify);
     ...
     */
    public void drawItem(Canvas g2,
     ...
     */
    public void fillDomainGridBand(Canvas g2,
                                   XYPlot plot,
                                   ValueAxis axis,
                                   Rectangle2D dataArea,
     ...
     * @param end  the end value.
     */
    public void fillRangeGridBand(Canvas g2,
                                  XYPlot plot,
                                  ValueAxis axis,
                                  Rectangle2D dataArea,
                                  double start, double end);
     ...
     * @param stroke  the stroke (<code>null</code> not permitted).
     */
    public void drawRangeLine(Canvas g2, XYPlot plot, ValueAxis axis,
     ...
     */
    public void drawDomainMarker(Canvas g2, XYPlot plot, ValueAxis axis,
     ...
     * @param dataArea  the axis data area.
     */
    public void drawRangeMarker(Canvas g2, XYPlot plot, ValueAxis axis,
            Marker marker, Rectangle2D dataArea);
