...
public abstract class CubicCurve2D implements Shape, Cloneable {
	...
	public static class Float extends CubicCurve2D implements Serializable {
		 ...
		 *            this {@code CubicCurve2D}
		 * @param x2
		 *            the X coordinate used to set the end point of this {@code
		 *            CubicCurve2D}
		 * @param y2
		 *            the Y coordinate used to set the end point of this {@code
		 *            CubicCurve2D}
		 * @since 1.2
		 */
	 ...
	 * 
	 * @return a {@code Point2D} that is the start point of the {@code
	 *         CubicCurve2D}.
	 * @since 1.2
	 */
	 ...
	 * 
	 * @return the X coordinate of the first control point of the {@code
	 *         CubicCurve2D}.
	 * @since 1.2
	 */
	 ...
	 * 
	 * @return the Y coordinate of the first control point of the {@code
	 *         CubicCurve2D}.
	 * @since 1.2
	 */
	 ...
	 * 
	 * @return a {@code Point2D} that is the first control point of the {@code
	 *         CubicCurve2D}.
	 * @since 1.2
	 */
	 ...
	 * 
	 * @return the X coordinate of the second control point of the {@code
	 *         CubicCurve2D}.
	 * @since 1.2
	 */
	 ...
	 * 
	 * @return the Y coordinate of the second control point of the {@code
	 *         CubicCurve2D}.
	 * @since 1.2
	 */
	 ...
	 * 
	 * @return a {@code Point2D} that is the second control point of the {@code
	 *         CubicCurve2D}.
	 * @since 1.2
	 */
	 ...
	 * 
	 * @return a {@code Point2D} that is the end point of the {@code
	 *         CubicCurve2D}.
	 * @since 1.2
	 */
	 ...
	 * 
	 * @param x1
	 *            the X coordinate used to set the start point of this {@code
	 *            CubicCurve2D}
	 * @param y1
	 *            the Y coordinate used to set the start point of this {@code
	 *            CubicCurve2D}
	 * @param ctrlx1
	 ...
	 * 
	 * @param x1
	 *            the X coordinate that specifies the start point of a {@code
	 *            CubicCurve2D}
	 * @param y1
	 *            the Y coordinate that specifies the start point of a {@code
	 *            CubicCurve2D}
	 * @param ctrlx1
	 ...
	 *            {@code CubicCurve2D}
	 * @param x2
	 *            the X coordinate that specifies the end point of a {@code
	 *            CubicCurve2D}
	 * @param y2
	 *            the Y coordinate that specifies the end point of a {@code
	 *            CubicCurve2D}
	...
	public boolean contains(double x, double y) {
		...
		double x2 = getX2();
		double y2 = getY2();
		int crossings = (Curve.pointCrossingsForLine(x, y, x1, y1, x2, y2) + Curve
				.pointCrossingsForCubic(x, y, x1, y1, getCtrlX1(), getCtrlY1(),
						getCtrlX2(), getCtrlY2(), x2, y2, 0));
